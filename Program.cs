...
builder.Services.AddHttpClient("ApiEstado", cliente =>
{
    cliente.BaseAddress = new Uri("http://localhost:5031/");
});
...
builder.Services.AddHttpClient("ApiTransformacionInstitucional", cliente =>
{
    cliente.BaseAddress = new Uri("http://localhost:5031/");
});
...
// Redirección automática a HTTPS si el Usuarios entra por HTTP.
